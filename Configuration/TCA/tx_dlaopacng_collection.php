...
return [
    'ctrl' => [
        ...
        'label'     => 'treeview_title_collection',
        'default_sortby' => 'ORDER BY uid',
        'rootLevel' => 0,
        'searchFields' => 'record_id,treeview_title_collection,listview_title,listview_type,listview_associate,listview_additional1,listview_additional2',
    ],
    'feInterface' => [
        'fe_admin_fieldList' => '',
    ],
    'interface' => [
        'showRecordFieldList' => 'treeview_title_collection,record_id',
        'maxDBListItems' => 25,
    ...
    'columns' => [
        ...
        'treeview_title_collection' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:dla_opac_ng/Resources/Private/Language/TCA.xml:tx_dlaopacng_collection.treeview_title_collection',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'max' => 1024,
    ...
    'types' => [
        '0' => ['showitem' => 'record_id,parent_id,treeview_title_collection,listview_title,listview_type,listview_associate,listview_additonal1,listview_additional2,hasChild'],
    ]
];
