$( document ).ready(function() {
    ...
    // filterAuthorityRelation_mv from data-attribute
    //var field1Parameter = 'tx_find_find[facet][filterAuthorityRelation_mv]';

    //var roleFacetParameter = 'tx_find_find[facet][filterAuthorityRole_mv]';
    ...
    $('.decisiontree').click(function(event) {
        ...
        var hasField2 = (typeof field2 !== "undefined" && field2 !== "");
        var field1Parameter = 'tx_find_find[facet][' + field1 + ']';
        var field2Parameter = hasField2 ? ('tx_find_find[facet][' + field2 + ']') : '';
                        ...
                        if (index%2 == 0) {
                            if (typeof data !== "undefined") {
                                ...
                                if (a == 0) {
                                    ...
                                    if (c != 1) {
                                        // relations
                                        // var addParameter = "&tx_find_find%5Bfacet%5D%5BfilterAuthorityRelation_mv%5D%5B" + encodeURI(this) + "%5D=1";
                                ...
                                } else if (a == 1 && hasField2){
                                    var c = url.searchParams.get(field2Parameter + "["+this+"]");

                                    if (c != 1) {
                                        // roles
                                        // var addParameter = "&tx_find_find%5Bfacet%5D%5BfilterAuthorityRole_mv%5D%5B" + encodeURI(this) + "%5D=1";
                                ...
                                if (active) {
                                    listElement.append('<li>' +
                                        '<a href="' + url + '" data-completefacet="' + this + '" class="activeFacet" rel="nofollow">' +
                                    ...
                                    listElement.append('<li>' +
                                        '<a href="' + linkUrl + '" data-completefacet="' + this + '" rel="nofollow">' +
